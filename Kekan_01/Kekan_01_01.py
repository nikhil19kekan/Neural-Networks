...
class LeftFrame:
	...
	def __init__(self, root, master, debug_print_flag=False):
		...
		#########################################################################
		##master.rowconfigure(2, weight=11, minsize=400)
	...
	def display_activation_function(self):
		input_values = np.linspace(-10, 10, 256, endpoint=False)
		activation = Kekan_01_02.calculate_activation_function(self.input_weight, self.bias, input_values,
